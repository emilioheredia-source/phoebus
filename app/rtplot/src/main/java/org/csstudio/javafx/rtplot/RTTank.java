...
public class RTTank extends Canvas
{
                          ...
                          final boolean normal)
    {
        ...
        {
            gc.setStroke(limitLineStroke());
            drawLimitLineAt(gc, plotBounds, min, max, normal, limit_lolo, limit_major_color);
            drawLimitLineAt(gc, plotBounds, min, max, normal, limit_lo,   limit_minor_color);
            drawLimitLineAt(gc, plotBounds, min, max, normal, limit_hi,   limit_minor_color);
            drawLimitLineAt(gc, plotBounds, min, max, normal, limit_hihi, limit_major_color);
            gc.setStroke(new BasicStroke(1f));
        }
    }
